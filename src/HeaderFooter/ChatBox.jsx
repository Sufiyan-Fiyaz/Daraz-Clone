...
const ChatBox = () => {
  ...
  const sendMessage = () => {
    ...
    } else if (lowerInput.includes("problem")) {
      botReply = "Sure, tell me about your problem";
    } else {
      botReply = (
        <span>
          I’m a support bot and don’t have permission to resolve account or
          order issues directly. For further assistance, please contact our{" "}
          <a
            href="https://buyer-helpcenter.daraz.pk"
            target="_blank"
    ...
    // Add bot reply after 1 sec delay
    setTimeout(() => {
  ...
  return (
    <>
      ...
      {/* Messages Button - Original styling preserved */}
      <div
        style={{
          position: "fixed",
          bottom: "20px",
